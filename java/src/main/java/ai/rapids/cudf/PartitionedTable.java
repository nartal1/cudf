...
public final class PartitionedTable implements AutoCloseable {
    ...
    /**
     * The package-private constructor is only called by the partition method in Table.TableOperation.partition
     * @param table - {@link Table} which contains the partitioned data
     * @param partitionOffsets - This param is used to populate the offsets into the returned table where
    ...
    /**
     * This method returns the partitions on this table. partitionOffsets[i] indicates the starting position of
     * partition 'i' in the partitioned table. Size of the partitions can be calculated by the next offset
     * Ex:
