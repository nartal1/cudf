...
class ReductionTest {
  ...
  private static Stream<Arguments> createBooleanParams() {
    ...
    return Stream.of(
        ...
        Arguments.of(ReductionOp.SUM, new Boolean[] { null, null, null }, Scalar.fromNull(DType.BOOL8)),
  ...
  private static Stream<Arguments> createIntParams() {
    ...
    return Stream.of(
        ...
        Arguments.of(ReductionOp.SUM, new Integer[] { null, null, null }, Scalar.fromNull(DType.INT32)),
  ...
  private static Stream<Arguments> createFloatParams() {
    ...
    return Stream.of(
        ...
        Arguments.of(ReductionOp.SUM, new Float[] { null, null, null }, Scalar.fromNull(DType.FLOAT32)),
  ...
  private static Stream<Arguments> createDoubleParams() {
    ...
    return Stream.of(
        ...
        Arguments.of(ReductionOp.SUM, new Double[] { null, null, null }, Scalar.fromNull(DType.FLOAT64)),
  ...
  private static Stream<Arguments> createDate32Params() {
    ...
    return Stream.of(
        ...
        Arguments.of(ReductionOp.MAX, new Integer[] { null, null, null }, Scalar.fromNull(DType.DATE32)),
